...
type expr =
  | EInteger of bool * string | EBool of bool | EString of string
  (* | EArray of id *)
  | EVar of id
...
let rec print_statement =
  ...
  | SPrint e -> print_ts "print: "; print_expr e; print_newline ()
  ...
  (* [EInteger b s] represents and integer. b is true if the integer is negative,
   *   or false if it is positive. s is a string representation of the magnitude of the integer
   *)
  type expr =
